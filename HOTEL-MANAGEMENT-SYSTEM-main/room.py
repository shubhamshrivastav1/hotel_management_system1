...
class Roombooking:
    def __init__(self,root):
        ...
        conn = mysql.connector.connect(host="Localhost",username="root",password="Hyperlink@06",database="hotel_management")
    ...
    def add_data(self):
        if self.var_contact.get()=="" or self.var_check_in.get()=="":
            ...
            try:
                conn = mysql.connector.connect(host="Localhost",username="root",password="Hyperlink@06",database="management")
                my_cursor = conn.cursor()
